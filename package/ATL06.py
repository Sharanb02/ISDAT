...
def h_li_plot(region,end_time):
    ...
    if region in ['Karakoram','West Himalaya','East Himalaya','Central Himalaya']:
        ...
        beam_gdf1.plot('h_li',cmap='BuPu',markersize=0.5,ax=ax,legend=True,cax=cax_,label="land",vmin=3000)
        beam_gdf2.plot('h_li',ax=ax,cmap='BuPu',markersize=0.5,vmin=3000)
        beam_gdf3.plot('h_li',ax=ax,cmap='BuPu',markersize=0.5,vmin=3000)
        ...
        playsound(os.getcwd().rsplit('/package')+'/mixkit-musical-reveal-961.wav')
    else:
